...
def main(comm,ard=False,plot=False,verbose=False):
	...
	loopback_mic = sc.all_microphones(include_loopback=True)[0]
...
if __name__ == "__main__":
	...
	if ard:
		comm = serial.Serial(port='COM3',baudrate=115200,timeout=0.1) # with this baud rate a byte is sent every ~0.00008680555 seconds
